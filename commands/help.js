...
module.exports.run = async (client, message, args) => {
    ...
    let help = new Discord.MessageEmbed()
      ...
      .addField("<a:emoji_2:872570903945441390> Examples", "g!start #giveaway 5m 1 Testing\ng!end Testing\ng!reroll Testing")
      .addField("<a:emoji_4:872571016612818994> Utility", "ping, invite", true)
      .addField("<a:emoji_5:872571053086503012> ℹ Information ℹ", "stats", true)
